...
DEFAULT_CONFIG = {
    ...
    "war_mode": {
        ...
        "server_check_interval_minutes": 5,
        "business_check_interval_seconds": 31,
        "online_check_interval_minutes": 1,
        "home_city_check_interval_minutes": 5,
        "jail_check_interval_minutes": 5,
        "skip_pin": False,
        "discord_webhook_url": "",
    },
    "consumables": {
