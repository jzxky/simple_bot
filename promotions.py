...
PROMOTIONS = [
    {"category": "Jail",         "rank": "Schooled",             "slug": "schooled",             "path": "/jail/schooled.asp",                 "a": "off+25/def+25",          "b": "off+30/def+20",          "int_a": 0,  "int_b": 0,  "default": "A"},
    {"category": "Jail",         "rank": "Mule",                 "slug": "mule",                 "path": "/jail/mule.asp",                     "a": "off+100/def+80",         "b": "off+80/def+100",         "int_a": 0,  "int_b": 0,  "default": "A"},
    {"category": "Jail",         "rank": "Hardrock",             "slug": "hardrock",             "path": "/jail/hardrock.asp",                 "a": "off+200/def+150",        "b": "off+250/def+150",        "int_a": 0,  "int_b": 0,  "default": "A"},
    {"category": "Jail",         "rank": "Lifer",                "slug": "lifer",                "path": "/jail/lifer.asp",                    "a": "off+200/def+80",         "b": "off+250/def+80",         "int_a": 0,  "int_b": 0,  "default": "A"},
    ...
    {"category": "Funeral",      "rank": "Mortician Assistant",  "slug": "mortician_assistant",  "path": "/promotion/mortassistant.asp",       "a": "off+12/def+100/int+15",  "b": "off+30/def+60/int+30",   "int_a": 15, "int_b": 30, "default": "B"},
    {"category": "Funeral",      "rank": "Undertaker",           "slug": "undertaker",           "path": "/promotion/undertaker.asp",          "a": "Option A",               "b": "Option B",               "int_a": 0,  "int_b": 0,  "default": "A"},
    {"category": "Funeral",      "rank": "Mortician",            "slug": "mortician",            "path": "/promotion/mort.asp",                "a": "off+15/def+90/int+20",   "b": "off+25/def+120/int+5",   "int_a": 20, "int_b": 5,  "default": "A"},
    ...
    {"category": "Law",          "rank": "Legal Secretary",      "slug": "legal_secretary",      "path": "/promotion/legalsec.asp",            "a": "off+15/def+100/int+20",  "b": "off+22/def+80/int+25",   "int_a": 20, "int_b": 25, "default": "B"},
    ...
    {"category": "Gangster",     "rank": "Giovane D'Honore",     "slug": "giovane_dhonore",      "path": "/promotion/Giovane%20D%60Honore.asp",      "a": "off+19/def+12/int+25",   "b": "off+29/def+20/int+10",   "int_a": 25, "int_b": 10, "default": "A"},
