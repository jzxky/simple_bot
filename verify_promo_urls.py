...
PROMOS = [
    ("Jail",         "Schooled",             "/jail/schooled.asp"),
    ("Jail",         "Mule",                 "/jail/mule.asp"),
    ("Jail",         "Hardrock",             "/jail/hardrock.asp"),
    ("Jail",         "Lifer",                "/jail/lifer.asp"),
    ...
    ("Law",          "Legal Secretary",      "/promotion/legalsec.asp"),
